...
public class Filter {
	...
	public static void main(String[] args) {
		...
		// também é possível definir os predicates e functions antes do stream com filter
		
		Predicate<Aluno> reprovados = a -> a.nota <= 6.9;
		Function<Aluno, String> saudacaoReprovado = a -> "Poxa " + a.nome + " você foi reprovado. Sua nota foi " + a.nota + " se esforce mais na próxima.";
